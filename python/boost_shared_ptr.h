/*
    This is a slightly modified version of nanobind's shared_ptr.h to support
    boost::shared_ptr in addition to std::shared_ptr.
*/
/*
...
template <typename T>
struct type_caster<boost::shared_ptr<T>> {

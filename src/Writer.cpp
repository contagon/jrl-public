...
std::map<std::string, MeasurementSerializer> Writer::loadDefaultMeasurementSerializers() {
  ...
  std::map<std::string, MeasurementSerializer> serializer_functions = {
    ...
    {RangeFactorWithTransformPose2Tag, [](gtsam::NonlinearFactor::shared_ptr& factor) { return serializeRangeFactorWithTransform<gtsam::Pose2>(&serialize<double>, &serialize<gtsam::Pose2>, RangeFactorWithTransformPose2Tag, factor); }},
    {RangeFactorWithTransformPose3Tag, [](gtsam::NonlinearFactor::shared_ptr& factor) { return serializeRangeFactorWithTransform<gtsam::Pose3>(&serialize<double>, &serialize<gtsam::Pose3>, RangeFactorWithTransformPose3Tag, factor); }},
    {RangeFactorWithTransform2DTag,    [](gtsam::NonlinearFactor::shared_ptr& factor) { return serializeRangeFactorWithTransform<gtsam::Pose2, gtsam::Point2>(&serialize<double>, &serialize<gtsam::Pose2>, RangeFactorWithTransform2DTag, factor); }},
    {RangeFactorWithTransform3DTag,    [](gtsam::NonlinearFactor::shared_ptr& factor) { return serializeRangeFactorWithTransform<gtsam::Pose3, gtsam::Point3>(&serialize<double>, &serialize<gtsam::Pose3>, RangeFactorWithTransform3DTag, factor); }},

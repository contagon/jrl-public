...
std::map<std::string, MeasurementParser> Parser::loadDefaultMeasurementParsers() {
  ...
  std::map<std::string, MeasurementParser> parser_functions = {
      ...
      {RangeFactorWithTransformPose2Tag, [](const json& input) { return parseRangeFactorWithTransform<gtsam::Pose2>(&parse<double>, &parse<gtsam::Pose2>, input); }},
      {RangeFactorWithTransformPose3Tag, [](const json& input) { return parseRangeFactorWithTransform<gtsam::Pose3>(&parse<double>, &parse<gtsam::Pose3>, input); }},
      {RangeFactorWithTransform2DTag,    [](const json& input) { return parseRangeFactorWithTransform<gtsam::Pose2, gtsam::Point2>(&parse<double>, &parse<gtsam::Pose2>, input); }},
      {RangeFactorWithTransform3DTag,    [](const json& input) { return parseRangeFactorWithTransform<gtsam::Pose3, gtsam::Point3>(&parse<double>, &parse<gtsam::Pose3>, input); }},
